...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        //Draw the texture as either a noise or color map
    ...
    {
        //Initialize noise map and color map
        float[,] noiseMap;
        Color[] colorMap = new Color[mapChunkSize * mapChunkSize];

        //Generate noise map
        noiseMap = Noise.GenerateNoiseMap(seed, mapChunkSize, mapChunkSize, noiseScale, octaves, persistance, lacunarity, offset);

        //Loop through noise map and apply correct region color
